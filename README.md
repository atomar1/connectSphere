# Web Development Final Project - *ConnectSphere*

Submitted by: **Ansh Tomar**

This web app: **A platform where users can join communities based on specific interests. Think of a "Matcha Club," a "Local Run Club," or a "Board Games" group. Inside each community, users can share posts, have discussions, and upvote content they like.**
